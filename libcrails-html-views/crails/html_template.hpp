...
namespace Crails
{
  ...
  public:
    ...
    std::string mail_field(const std::string& name, const std::string& value, std::map<std::string, std::string> attrs = {}) const;
    ...
    {
      if (value.is_localized())
      {
        attrs["data-localized"] = "1";
